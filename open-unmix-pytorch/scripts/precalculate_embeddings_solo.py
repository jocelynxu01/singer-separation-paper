...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Precompute SOLO singer embeddings.")
    script_dir = Path(__file__).resolve().parent
    parser.add_argument(
        "--base-dir",
        type=Path,
        default=script_dir,
        help="Directory containing SOLO_*_segments.csv files."
    )
    parser.add_argument(
        "--model-path",
        type=Path,
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=script_dir / "embeddings" / "SOLO_clean_embeddings",
...
if __name__ == "__main__":
    ...
    segment_files = {
        "train": base_dir / "SOLO_train_segments.csv",
        "valid": base_dir / "SOLO_valid_segments.csv",
        "test": base_dir / "SOLO_test_segments.csv",
    }
